...
updater.addon = "blender_ctr_toolkit"
...
def register(bl_info):
    ...
    updater.user = "kjorgecaballero"
    updater.repo = "blender-ctr-toolkit"
    updater.website = "https://github.com/kjorgecaballero/blender-ctr-toolkit/"
    updater.current_version = bl_info["version"]
    updater.subfolder_path = ""
    updater.verbose = False
    updater.use_print_traces = True
    updater.backup_current = True
    updater.backup_ignore_patterns = ["__pycache__"]
    updater.overwrite_patterns = ["*.py", "*.pyc", "*.png", "*.md", "*.txt"]
