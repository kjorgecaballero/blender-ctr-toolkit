"""
Addon updater module for Blender addons.
Based on CGCookie's blender-addon-updater (version 1.1.1)
"""
...
class SingletonUpdater:
    ...
    def get_tags(self):
        ...
        if self._tags is None:
            ...
            self.print_verbose("{} branch found, no releases: {}".format(branch, self._tags[0]))
                ...
                or (len(self._tags) == 0 and not self._include_branches) and self._prefiltered_tag_count > 0):
            self._tag_latest = None
    ...
    def reload_addon(self):
        ...
        if "addon_disable" in dir(bpy.ops.wm):
    ...
    def past_interval_timestamp(self):
        ...
        offset = timedelta(days=self._check_interval_days + 30 * self._check_interval_months,
                           hours=self._check_interval_hours, minutes=self._check_interval_minutes)
